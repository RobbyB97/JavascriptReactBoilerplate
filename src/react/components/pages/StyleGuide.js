...
export class StyleGuide extends React.Component {
    ...
    render() {
        return (
            <div id="StyleGuide">
                <section className="StyleGuide__header">
                    <h1>Style Guide</h1>
                    <p>You can use this page to set the default styles for the theme of your website, and see the results at a glance. :)</p>
                </section>

                <section className="StyleGuide__content">
